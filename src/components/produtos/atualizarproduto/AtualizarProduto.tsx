                ...
                >
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            ...
                            name="nomeProduto"
                            className="w-full bg-[#f0f0f0] pl-4 pr-4 py-3 rounded-xl shadow-md focus:outline-none focus:ring-2 focus:ring-[#FF4D38]"
                    ...
                    <button
                        className="text-white bg-[#FF4D38] flex items-center justify-center h-10 w-[120px] rounded-lg shadow-md mt-4 mx-auto min-w-[150px] mb-7"
                        type="submit"
                        disabled={isLoading}
                    >
                        {isLoading ? (
