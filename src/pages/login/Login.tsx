    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 h-screen bg-[#FFFFFF] font-rubik">
      <div className="flex justify-center items-center w-full h-screen px-10">
        <form onSubmit={login} className="flex flex-col w-full max-w-md gap-6">
          ...
          <button
  type="submit"
  className="bg-[#FF4D38] text-white font-semibold text-2xl px-15 py-2 rounded-xl border border-[#FF4D38]/50 hover:bg-[#e04430] mt-2 w-max mx-auto flex justify-center"
>
  {isLoading ? (
    <RotatingLines
      strokeColor="white"
...
<p className="text-center text-lg text-[#666666]">
  ...
  Clique aqui e <a href="/cadastro" className="text-[#666876] font-bold underline">cadastre-se!</a>
</p>
