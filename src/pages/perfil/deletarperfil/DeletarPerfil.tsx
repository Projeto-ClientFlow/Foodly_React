      ...
      <div className="flex flex-col w-3/4 md:w-1/2 gap-8 text-center">
        ...
        <div className="flex justify-center gap-6 mt-4">
          ...
          <button
            ...
            className="bg-gray-600 hover:bg-gray-800 text-white font-semibold px-6 py-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF4D38] cursor-pointer"
          >
            Deletar
          </button>
        </div>
